                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="input-field col s12 l2">
                                                                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control">
                                                                    ...
                                                                    <asp:ListItem Value="2" Text="Tên shop"></asp:ListItem>
                                                            ...
                                                            <div class="input-field col s12 l6">
                                                                <asp:DropDownList runat="server" ID="ddlStatus">
                                                                    ...
                                                                    <asp:ListItem Value="4" Text="Shop phát hàng"></asp:ListItem>
                                                                    <asp:ListItem Value="6" Text="Đã về kho TQ"></asp:ListItem>
                                                                    <asp:ListItem Value="8" Text="Hàng đang về VN"></asp:ListItem>
