    ...
    <form id="form1" runat="server" class="login-form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s12 align-center">
                                    <span class="img logo-login">
                                        <a href="/">
                                            <img src="/App_Themes/GiangHuy/images/logo.png" alt="logo"></a></span>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6">
                                    ...
                                    <span class="helper-text">
                                        <asp:RegularExpressionValidator
                                            ...
                                            runat="server"
                                            ErrorMessage="Mật khẩu ít nhất 8 ký tự, có ít nhất 1 số, 1 chứ cái viết hoa và ký tự đặc biệt." Display="Dynamic"
                                            ControlToValidate="txtpass" ForeColor="Red"
                                            ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,15}$" ValidationGroup="Group" />
                                    </span>
                                </div>
                                <div class="input-field col s12 m6">
                                    <i class="material-icons prefix ">lock_outline</i>
        ...
        <script>
            function register() {
                ...
                var SalesID = $('#<%=ddlSale.ClientID%>').val();
                if (SalesID == 0) {
                    alert('Bạn chưa chọn nhân viên sales');
                    return;
                }                
                else {
