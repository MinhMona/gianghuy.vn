...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <table class="table bordered highlight   ">
                            <thead>
                                <tr>
                                    ...
                                    <th>Ngày YCXK</th>
                                    <th>Ngày XK</th>
                                    <th>Thông tin kiện</th>
                                    <th>Thông tin cước (VNĐ)</th>
                                    <th>Hình thức </br> nhận hàng</th>
                                    <th>Thanh toán</th>
                                    <th>Xuất kho</th>
                                    <th>Ghi chú </br> khách hàng</th>
                                    <th>Ghi chú </br> nhân viên</th>
                                    <th>Thao tác</th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <script type="text/javascript">
        ...
        function Delete(obj, ID) {
            var c = confirm('Bạn muốn hủy mã thống kê này?');
            if (c) {
