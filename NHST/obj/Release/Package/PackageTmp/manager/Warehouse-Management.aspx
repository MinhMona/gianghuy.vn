...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="list-table card-panel">
                    <div class="filter">
                        <div class="search-name input-field no-margin">
                            ...
                            <asp:Button runat="server" ID="btnSearch" UseSubmitBehavior="false" Style="display: none" ValidationGroup="n" OnClick="btnSearch_Click" />
                        </div>
                        <a href="#addBadge" class="btn  modal-trigger waves-effect">Thêm bao hàng</a>
                    </div>
    ...
    <asp:Button ID="btnDeposit" runat="server" UseSubmitBehavior="false" OnClick="btnExcel_Click" Style="display: none" />
