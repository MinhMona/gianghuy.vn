        ...
        <div class="modal-bd">
            <div class="row">
                ...
                <div class="input-field col s12 m12">
                    ...
                    <label for="kg_weight">Giao hàng</label>
                </div>
                <div class="input-field col s12 m12">
                    <asp:TextBox runat="server" ID="txtExNote" TextMode="MultiLine"></asp:TextBox>
                    <label for="kg_weight" class="active">Ghi chú nhân viên</label>
                </div>
            </div>
        </div>
        <div class="modal-ft">
                                ...
                                if (isExist == false) {
                                    if (check == false) {
                                        ...
                                        if (ordertype != 3) {
                                            ...
                                            html += "<tr><td rowspan=\"10\" class=\"grey lighten-2\">" + ordertypeString + "</td></tr>";
                                        }
