                                ...
                                <div class="print-header">
                                    <div class="row">
                                        <div class="col s6">
                                            <div class="hd-left">
                                                <div class="content">
                                                    <p class="name">GIANGHUY.COM</p>
                                                    <p class="address">Địa chỉ: 93 Phố 8-3 . Phường Quỳnh Mai . Quận Hai Bà Trưng . TP.Hà Nội</p>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col s12 m4">
                                                    <div class="action-wrap">
                                                        ...
                                                        <a class="btn primary-btn btn-hy" style="margin-left:20px" onclick="DeleteProduct()">Ẩn đơn chưa thanh toán</a>

                                                        <%-- <asp:Panel ID="pnDelete" runat="server" Visible="false">
                                                            <asp:Button ID="btnDelete" runat="server" Text="Xóa đơn chưa thanh toán" CssClass="btn"
    ...
    <telerik:RadScriptBlock ID="scr" runat="server">
        <script type="text/javascript">
            function DeleteProduct(ID) {
                var r = confirm("Bạn muốn ẩn đi những đơn này?");
                if (r == true) {
