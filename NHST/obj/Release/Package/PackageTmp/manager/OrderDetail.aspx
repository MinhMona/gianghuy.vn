...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="card-panel">
                            <div class="order-stick-detail">
                                ...
                                <div class="action-btn center-align ">
                                    ...
                                    <asp:Literal ID="ltrBtnUpdateHHForSale" runat="server"></asp:Literal>
                                    ...
                                    <asp:Button ID="btnUpdateHHForSale" runat="server" CssClass="btn pill-btn primary-btn admin-btn full-width"
                                        UseSubmitBehavior="false" Style="display: none" Text="CẬP NHẬT" OnClick="btnUpdateHHForSale_Click" />
                                    ...
                                    <div class="content-panel">
                                        ...
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox runat="server" ID="pPhuPhiCNY" onkeyup="CountPhuPhi('ndt')" placeholder="0" type="text" value=""></asp:TextBox>
                                                        <label>Tệ (¥)</label>
                                                    </div>
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox runat="server" ID="pPhuPhiVND" onkeyup="CountPhuPhi('vnd')" placeholder="0" type="text" value=""></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12 m6">
                                                        <asp:TextBox ID="pBuyNDT" runat="server" onkeyup="CountFeeBuyPro()" placeholder="0" type="text" data-type="number" value=""></asp:TextBox>
                                                        <label>Tệ (¥)</label>
                                                    </div>
                                                    <div class="input-field col s12 m6">
                                        ...
                                        <asp:Panel ID="Panel1" runat="server">
                                            <div class="order-row">
                                                <div class="left-fixed">
                                                    <p class="txt">Hoa hồng mặc cả cho sale</p>
                                                </div>
                                                <div class="right-content">
                                                    <div class="row">
                                                        <div class="row">
                                                            <div class="center-checkbox col s12" style="margin-left: 10px;">
                                                                <label>
                                                                    <input type="checkbox" id="ckhkPercentHHForSale" class="chk-check-option" data-id="8" />
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                            <asp:HiddenField ID="ckPercentHHForSale" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </asp:Panel>
                                        <asp:HiddenField ID="hdfPercentHHForSaleVisible" runat="server" />
                        ...
                        <div class="card-panel">
                            <div id="history-list" class="section scrollspy history-list">
                                ...
                                <div class="child-fee" style="display: none">
                                    <div class="title-subheader grey lighten-2">
                                        <p class="black-text no-margin font-weight-500">Danh sách vvận đơn</p>
                                    </div>
                                    <div class="content-panel">
                                        <div class="responsive-tb">
                                            <table class="table highlight   ">
    ...
    <telerik:RadScriptBlock ID="rsc" runat="server">
        ...
        <script>
            ...
            function CountPhuPhi(type) {
                var phuphindt = $("#<%= pPhuPhiCNY.ClientID%>").val();
                var phuphivnd = $("#<%= pPhuPhiVND.ClientID%>").val();
                if (type == "vnd") {
                    if ((phuphivnd) != null || phuphivnd != "") {
                        var ndt = phuphivnd / currency;
                        $("#<%= pPhuPhiCNY.ClientID%>").val(ndt);
                    }
                    else {
                        $("#<%= pPhuPhiVND.ClientID%>").val(0);
                        $("#<%= pPhuPhiCNY.ClientID%>").val(0);
                    }
                }
                else {
                    if ((phuphindt) != null || phuphindt != "") {

                        var vnd = phuphindt * currency;
                        $("#<%= pPhuPhiVND.ClientID%>").val(vnd);
                    }
                    else {
                        $("#<%= pPhuPhiVND.ClientID%>").val(0);
                        $("#<%= pPhuPhiCNY.ClientID%>").val(0);
            ...
            function UpdateHHForSale() {
                ...
                $("#<%=hdfListCheckBox.ClientID%>").val(chuoi);
                $("#<%=btnUpdateHHForSale.ClientID%>").click();
            ...
            $(document).ready(function () {
                ...
                var checkcb3 = $("#<%= hdfPercentHHForSaleVisible.ClientID%>").val();
                ...
                var cb8 = $("#<%=ckPercentHHForSale.ClientID %>").val();
                ...
                if (checkcb3 == "1") {
                    ...
                    $('#ckhkPercentHHForSale').prop("checked", (/true/i).test(cb8.toLowerCase()))
                }
