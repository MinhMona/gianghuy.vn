<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterNew.Master" AutoEventWireup="true" CodeBehind="Cart2.aspx.cs" Inherits="NHST.Cart1" %>
                            ...
                            <div class="sec warning-sec custom-width-50">
                                ...
                                <p class="warning-txt">
                                    Sản phẩm trong giỏ sẽ tự động xóa trong vòng 30 ngày. Người bán trên website 1688.com thường có quy định về số lượng mua tối thiểu, bội số mỗi sản phẩm, giá trị đơn hàng 
                                            tối thiểu và sẽ từ chối bán nếu không đáp ứng. 
                                    Trong trường hợp đó GIANGHUY.COM sẽ hủy những đơn hàng này và không báo trước.
                                </p>
                                <div class="clear"></div>
                            </div>
