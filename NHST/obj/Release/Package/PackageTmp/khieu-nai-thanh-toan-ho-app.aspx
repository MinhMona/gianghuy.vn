<%@ Page Title="Khiếu nại thanh toán hộ app" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="khieu-nai-thanh-toan-ho-app.aspx.cs" Inherits="NHST.khieu_nai_thanh_toan_ho_app" %>
    ...
    <main id="main-wrap">
        <div class="page-wrap">
            <asp:Panel ID="pnMobile" runat="server" Visible="false">
                <div class="page-body">
                    <div class="all">
                        <h1 class="page-title">KHIẾU NẠI THANH TOÁN HỘ</h1>
                    </div>
