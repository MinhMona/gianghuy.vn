                                                        ...
                                                        <table class="table highlight bordered centered">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tb-date">Tên hàng</th>
                                                                    <th class="tb-date">Giá trị đơn hàng (VNĐ)</th>
                                                                    <th class="tb-date">Ghi chú</th>
                                                                    <th class="tb-date">Bảo hiểm</th>
                                                            ...
                                                            <tbody class="list-product">
                                                                <tr class="slide-up product-item">
                                                                    ...
                                                                    <td>
                                                                        <input class="pack-name" type="text"></td>
                                                                    <td>
                                                                        <input class="pack-price" value="0" type="number"></td>
                                                                    <td>
    ...
    <script>
        $(document).ready(function () {
            $('.create-product .add-product').on('click', function () {
                ...
                var html = ` <tr class="slide-up product-item">
                       <td><input class="pack-code" type="text"></td>
                       <td><input class="pack-name" type="text"></td>
                       <td><input class="pack-price" value="0" type="number"></td>
        ...
        function CreateOrder() {
            ...
            $(".product-item").each(function () {
                ...
                validateText(packname_obj);
                validateText(packprice_obj);                
            });
            ...
            if (check == true) {
                ...
                $(".product-item").each(function () {
                    ...
                    var packinsurrance = 0;
                    if (item.find(".pack-insurrance").is(":checked")) {
                        packinsurrance = 1
                    }
                    html += packcode + "]" + packnote + "]" + packname + "]" + packprice + "]" + packinsurrance + "|";
                });
                $.ajax({
                    type: "POST",
