...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
            ...
            <asp:Panel ID="pnMobile" runat="server" Visible="false">
                <div class="page-body">
                    <div class="all donhang donhang_list">
                        ...
                        <%--    <ul>
                                <li>Tổng số đơn hàng: 39</li>
                                <li>Tổng số đơn hàng chưa cọc: 39</li>
                                <li>Tổng số đơn hàng đã đặt cọc: 39</li>
                                <li>Tổng số đơn hàng đã mua hàng: 39</li>
                                <li>Tổng số đơn hàng đã về kho TQ: 39</li>
                                <li>Tổng số đơn hàng đã vè kho VN: 39</li>
                                <li>Tổng số đơn hàng đã hoàn thành: 39</li>
                            </ul>--%>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function payallorder(ID) {
            var r = confirm("Bạn muốn thanh toán đơn: " + ID);
            if (r == true) {
