<%@ Page Language="C#" MasterPageFile="~/UserMasterNew.Master" AutoEventWireup="true" CodeBehind="khieu-nai-thanh-toan-ho.aspx.cs" Inherits="NHST.khieu_nai_thanh_toan_ho" %>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="page-title mt-2 center-align">
                                        <h4>Danh sách khiếu nại thanh toán hộ</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
