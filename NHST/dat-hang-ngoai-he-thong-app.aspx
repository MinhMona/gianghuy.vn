...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                        ...
                        <div class="content_page">
                            ...
                            <div class="product-list">
                                <div class="form-input products">
                                    ...
                                    <input class="input_control product-price" type="text" name="" placeholder="Giá sản phẩm">
                                    <ul class="quantity_input">
                                        <li style="width: 55%;">
                                            <p>Số lượng:</p>
                                        </li>
    ...
    <script type="text/javascript">
        function addProduct() {
            ...
            html += "   <input class=\"input_control product-price\" type=\"text\" name=\"\" placeholder=\"Giá sản phẩm\">";
            html += "     <ul class=\"quantity_input\">";
            ...
            if ($(".products").length > 0) {
                ...
                if (check == true) {
                    ...
                    $(".products").each(function () {
                        ...
                        html += productlink + "]" + productname + "]" + productsizecolor + "]" + productprice + "]" + productquantity + "]" + productrequest + "]" + image + "|";
                    });
