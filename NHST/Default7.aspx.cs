        ...
        public void LoadData()
        {
            ...
            if (services.Count > 0)
            {
                foreach (var item in services)
                {
                    ...
                    ltrService.Text += "<div class=\"content wow fadeInUp\" data-wow-delay=\".6s\" data-wow-duration=\"1s\">";
                    ...
                    if (!string.IsNullOrEmpty(item.ServiceLink))
                        ltrService.Text += "<a href=\"" + item.ServiceLink + "\" class=\"btn btn-xt\">Xem thêm <i class=\"fa fa-long-arrow-right\"></i></a>";
                    ltrService.Text += "</div>";
                    ltrService.Text += "</div>";
                }
            }
            ...
            if (steps.Count > 0)
            {
                ...
                foreach (var item in steps)
                {
                    ...
                    if (count == 1)
                    {
                        ltrStep1.Text += "<li data-tab=\"js-"+count+"\" class=\"active\">"+item.StepName+" </li>";
                    }
                    else
                    {
                        ltrStep1.Text += "<li data-tab=\"js-" + count + "\">" + item.StepName + " </li>";
                    }

                    if (count == 1)
                    {

                        ltrStep2.Text += "<div class=\"c-tab__item js-"+count+" active\">";
                    }
                    else
                    {

                        ltrStep2.Text += "<div class=\"c-tab__item js-" + count + "\">";
                    }

                    ltrStep2.Text += "<div class=\"content\">";
                    ltrStep2.Text += "<h3 class=\"txt\">" + item.StepName + "</h3>";
                    ltrStep2.Text += "<p class\"desc\">" + item.StepContent + "</p>";
                    if (!string.IsNullOrEmpty(item.StepLink))
                        ltrStep2.Text += "<a href=\"" + item.StepLink + "\" class=\"btn-main btn bg-yellow\">Xem thêm</a>";
                    ltrStep2.Text += "</div>";
                    ltrStep2.Text += "</div>";
                    count++;
            ...
            if (ql.Count > 0)
            {
                foreach (var q in ql)
                {
                    ltrBenefits.Text += "<div class=\"item-cnt\">";
                    ltrBenefits.Text += "<div class=\"icon-bnf\">";
                    ltrBenefits.Text += "<img src=\"" + q.Icon + "\" alt=\"\">";
                    ltrBenefits.Text += "</div>";
                    ltrBenefits.Text += "<div class=\"text-bnf\">";
                    ltrBenefits.Text += "<h5 class=\"txt\">" + q.CustomerBenefitName + "</h5>";
