...
namespace NHST.Models
{
    ...
    public partial class tbl_Configuration
    {
        ...
        public string InsurancePercentTrans { get; set; }
        public string SalePercentTrans { get; set; }
        public Nullable<double> MinFeeService { get; set; }
        public Nullable<double> HHForSalePercent { get; set; }
    }
}
