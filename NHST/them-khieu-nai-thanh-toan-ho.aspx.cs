...
namespace NHST
{
    public partial class them_khieu_nai_thanh_toan_ho : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            {
                int PayHelpID = RouteData.Values["id"].ToString().ToInt(0);
                if (PayHelpID > 0)
                {
                    ...
                    if (u != null)
                    {
                        ...
                        var payHelp = PayhelpController.GetByIDAndUID(PayHelpID, UID);
                        if (payHelp != null)
                        {
                            txtOrderID.Text = PayHelpID.ToString();
                        }
                    }
                }
            }
