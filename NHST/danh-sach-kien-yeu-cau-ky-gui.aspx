                                        ...
                                        <div class="total-info mb-2 pb-10">
                                            ...
                                            <div class="row section mt-1">
                                                <div class="col s12">
                                                    ...
                                                    <a href="javascript:;" id="exportselected" onclick="requestexportselect()" style="display: none; background-color: green;" class="btn">Yêu cầu xuất kho các kiện đã chọn</a>

                                                    <a href="javascript:;" onclick="requestoutstockAll()" style="background-color: blue;" class="btn">Yêu cầu xuất kho tất cả kiện</a>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="input-field col s12 l2">
                                                                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control">
                                                                    <asp:ListItem Value="3" Text="Tìm theo ID đơn"></asp:ListItem>
                                                            ...
                                                            <div class="input-field col s12 l4">
                                                                <asp:DropDownList runat="server" ID="ddlPhanTrang">
                                                                    <asp:ListItem Value="-1" Text="Phân trang 20"></asp:ListItem>
                                                                    <asp:ListItem Value="1" Text="Phân trang 30"></asp:ListItem>
                                                                    <asp:ListItem Value="2" Text="Phân trang 40"></asp:ListItem>
                                                                    <asp:ListItem Value="3" Text="Phân trang 50"></asp:ListItem>
                                                                </asp:DropDownList>
                                                                <label for="status">Phân trang</label>
                                                            </div>
    ...
    <script>
                    ...
                    success: function (msg) {
                        ...
                        if (ret != "0") {
                            ...
                            if (c == true) {
                                ...
                                var TotalFeeInsurrance = data[13];
                                ...
                                if (status == 1) {
                                    ...
                                    html += "   <p>Tổng số mã xuất kho của qúy khách  : <strong>" + totalCount + "</strong></p>";
                                    html += "</div>";
                                    html += "<div class=\"popup-row\">";
                                    html += "<p>Tổng số kg xuất kho: " + totalWeight + " kg - <strong>" + totalWeightPriceVNDstr + "</strong> VNĐ.</p>";
                                    html += "</div>";
                                    html += "<div class=\"popup-row\">";
                                    html += "<p>Phí bảo hiểm đơn hàng: <strong>" + TotalFeeInsurranceStr + "</strong> VNĐ.</p>";
                                    html += "</div>";
                                    //html += "<div class=\"popup-row\">";
                                    ...
                                    html += "</div>";
                                    html += "<div class=\"popup-row\">";
                                    html += "<p>Phụ phí đặc biệt: <strong>" + TotalAdditionFeeVNDstr + "</strong> VNĐ.</p>";
                                    html += "</div>";
                                    ...
                                    alert('Các kiện hàng không cùng kho, nên không thể tạo yêu cầu xuất kho. Vui lòng liên hệ BQT hệ thống GiangHuy.');
                                }
                                else {
                                    $("#<%=hdfListID.ClientID%>").val(listID);
                                    var leftmoney = data[13];
                                    var leftmoneystr = formatThousands(leftmoney, 0);
                                    var TotalFeeInsurrance = data[14];
                                    var TotalFeeInsurranceStr = formatThousands(TotalFeeInsurrance, 0);
                                    var button = "";
                                    button += "<a href=\"javascript:;\" class=\"btn btn-close pill-btn primary-btn main-btn hover\" onclick='ThanhToanTaiKho($(this))'>Thanh toán tại kho</a>";
                                    var html = "";
                ...
                success: function (msg) {
                    ...
                    if (ret != "0") {
                        ...
                        if (c == true) {
                            ...
                            var TotalSensoredFeeVNDstr = formatThousands(TotalSensoredFeeVND, 0);
                            var TotalFeeInsurrance = data[16];
                            var TotalFeeInsurranceStr = formatThousands(TotalFeeInsurrance, 0);
                            if (status == 1) {
                                $("#<%=hdfListID.ClientID%>").val(listID);
                                var button = "<a href=\"javascript:;\" class=\"btn btn-close pill-btn primary-btn main-btn hover\" onclick=\"paytoexport($(this))\">Thanh toán</a>";
                            ...
                            else if (status == 3)
                            {
                                ...
                                var leftmoneystr = formatThousands(leftmoney, 0);
                                var TotalFeeInsurrance = data[12];
                                var TotalFeeInsurranceStr = formatThousands(TotalFeeInsurrance, 0);
                                var button = "";
                                button += "<a href=\"javascript:;\" class=\"btn btn-close pill-btn primary-btn main-btn hover\" onclick='ThanhToanTaiKho($(this))'>Thanh toán tại kho</a>";
                                var html = "";
        ...
        function showPopup(title, content, button) {
            ...
            var fr = "<div id='pupip_home' class=\"columns-container1\">" +
                "  <div class=\"center_column col-xs-12 col-sm-5 fix-hei\" id=\"popup_content_home\">";
