        ...
        public void LoadNotification()
        {
            ...
            if (acc != null)
            {
                ...
                if (config != null)
                {
                    ...
                    var noti = NotificationsController.GetTop10(acc.ID);
                    if (acc.RoleID != 1)
                    {
                    ...
                    decimal accountTotalValue = acc.TotalTransactionValue ?? 0;
                    decimal percent = 0;
                    if (acc.RoleID == 1)
                    {
                        percent = (accountTotalValue / userLevel.ToTransactionValue ?? 0) * 100;
                    }
                    ...
                    //ltrHeaderLeft.Text += "<div class=\"level__info\" ><p style=\" margin: 0; \">Tổng</p><p style=\" margin: 0; \">" + string.Format("{0:N0}", accountTotalValue) + " / " + string.Format("{0:N0}", userLevel.ToTransactionValue) + " VNĐ</p></div>";
                    //ltrHeaderLeft.Text += "<div class=\"level__info\" ><p style=\" margin: 0; \">Tiến độ</p><p style=\" margin: 0; \" class=\"rank\">" + percent + $"%</p></div>";
                    //ltrHeaderLeft.Text += "<div class=\"level__process\"><span style=\"width: " + percent + "%\"></span></div>";
                    ltrHeaderLeft.Text += "<div class=\"level__process\"><span style=\"width: " + tile + "%\"></span></div>";

                    ltrHeaderLeft.Text += "</div>";
                    ltrHeaderLeft.Text += "<div class=\"balance\"><p>Số dư vnđ:</p>";
                    ltrHeaderLeft.Text += "<div class=\"balance__number\"><p class=\"vnd\">" + string.Format("{0:N0}", acc.Wallet) + " vnđ</p></div>";
                    ltrHeaderLeft.Text += "</div>";
                    ltrHeaderLeft.Text += "<div class=\"balance\"><p>Số dư tệ:</p>";
                    ltrHeaderLeft.Text += "<div class=\"balance__number\"><p class=\"vnd\">" + acc.WalletCYN + " ¥</p></div>";
                    ltrHeaderLeft.Text += "</div>";
                    if (acc.RoleID != 1)
