    ...
    public partial class tao_ma_van_don_ky_gui : System.Web.UI.Page
    {
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (obj_user != null)
            {
                ...
                if (conf != null)
                {
                    currency = Convert.ToDouble(conf.AgentCurrency);
                    PercentInsurrance = Convert.ToDouble(conf.InsurancePercentTrans);
                }
                ...
                if (!string.IsNullOrEmpty(listPackage))
                {
                    ...
                    if (list.Length - 1 > 0)
                    {
                        ...
                        for (int i = 0; i < list.Length - 1; i++)
                        {
                            ...
                            string tID = TransportationOrderNewController.InsertNew(UID, username, "0", currency.ToString(), "0", "0", "0", "0", "0", "0", "0", "0", 0, code, 1, note, "", "0", "0",
