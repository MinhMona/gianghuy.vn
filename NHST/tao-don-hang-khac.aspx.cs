        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (obj_user != null)
            {
                ...
                string kq = MainOrderController.Insert(UID, "", "", "", false, "0", false, "0", false, "0",
                            ...
                            "0", "", fullname, address, email, phone, 0, "0", currency.ToString(), TotalPriceVND.ToString(),
                            salerID, dathangID, currentDate, UIDCreate, AmountDeposit, 3);
                ...
                if (idkq > 0)
                {
                    ...
                    for (int i = 0; i < products.Length - 1; i++)
                    {
                        ...
                        string imagein = "";
                        if (!string.IsNullOrEmpty(imageinput) && imageinput != "undefined")
                        {
                            imagein = imageinput;
                        }
