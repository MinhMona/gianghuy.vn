<%@ Page Language="C#" MasterPageFile="~/UserMasterNew.Master" AutoEventWireup="true" CodeBehind="them-khieu-nai-thanh-toan-ho.aspx.cs" Inherits="NHST.them_khieu_nai_thanh_toan_ho" %>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="page-title mt-2 center-align">
                                        <h4>Tạo khiếu nại thanh toán hộ mới</h4>
                                    </div>
                                </div>
                            </div>
...
<%--                                        NumberFormat-DecimalDigits="0"--%>
                                    ...
                                    <label for="rp_yuan" class="active">Số tiền (¥)</label>
                                </div>
