...
namespace NHST.manager
{
    public partial class Warehouse_Management : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            var la = BigPackageController.GetAllBySQL_DK(search, page, 10);
            pagingall(la, total);
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (obj_user != null)
            {
                ...
                var la = SmallPackageController.GetAllByBigPackageID(OID, search);
                ...
                StrExport.Append("      <th><strong>Mã ĐH mua hộ</strong></th>");
                StrExport.Append("      <th><strong>Mã ĐH vận chuyển</strong></th>");
                ...
                foreach (var item in la)
                {
                    ...
                    StrExport.Append("      <td>" + item.TransportationOrderID + "</td>");
                ...
                string PackageCode = "";
                var big = BigPackageController.GetByID(OID);
                if (big != null)
                {
                ...
                string strFile = "OrderTracsionCode - "+ PackageCode + ".xls";
        ...
        public void pagingall(List<BigPackageController.Warehouse> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    hcm.Append("<li><a href = \"Package-Detail.aspx?ID=" + item.ID + "\" class=\"btn\">Cho vào bao lớn</a></li>");
                    hcm.Append("<li><a href=\"javascript:;\" onclick=\"btnExcel('" + item.ID + "')\" class=\"btn\">Xuất Excel</a></li>");
                    hcm.Append("</ul>");
                    hcm.Append("</td>");
                    hcm.Append("</tr>");
                }
