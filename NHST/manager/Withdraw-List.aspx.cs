...
namespace NHST.manager
{
    public partial class Withdraw_List : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            int total = WithdrawController.GetTotalSQL(search_name.Text.Trim(), "");
            pagingall(la, total);
        }
                ...
                if (w.Status < 3)
                {
                        ...
                        else
                        {
                            ...
                            if (user_rut != null)
                            {
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    {
                                        NotificationsController.Inser(user_rut.ID, user_rut.Username, 0, "BQT Giang Huy đã duyệt lệnh rút tiền của bạn.", 3, currentDate, username, true);
                                        //string strPathAndQuery = Request.Url.PathAndQuery;
                                        //string strUrl = Request.Url.AbsoluteUri.Replace(strPathAndQuery, "/");
                                        //string datalink = "" + strUrl + "rut-tien/";
                                        //PJUtils.PushNotiDesktop(user_rut.ID, "BQT Giang Huy đã duyệt lệnh rút tiền của bạn.", datalink);
                                    }
                                    ...
                                    //        html.Append("<tr>");
                                    //        html.Append("<td style=\"padding: 10px; background-color: #fca777; color: #fff; text-align: center\"><strong><p>KÍNH CHÀO QUÝ KHÁCH!</p><p><a style=\"text-decoration: none\" href=\"https://GIANGHUY.COM/\" target=\"_blank\"><strong>GIANGHUY.COM<strong></a> THÔNG BÁO RÚT VÍ THÀNH CÔNG</p></strong></td>");
                                    //        html.Append("</tr>");
                                    //        html.Append("<tr>");
                                    ...
                                    //        html.Append("</tr>");
                                    //        html.Append("<tr>");
                                    //        html.Append("<td><a style=\"text-decoration: none\" href=\"https://GIANGHUY.COM/\" target=\"_blank\"><strong>GIANGHUY.COM<strong></a> chân thành cảm ơn!</td>");
                                    //        html.Append("</tr>");
                                    //        html.Append("<tr>");
                                    //        html.Append("<td>==============================</td>");
                                    //        html.Append("<tr>");
                                    //        html.Append("<td>Mọi thắc mắc xin vui lòng liên hệ: <a href=\"tel:19003304\">19003304</a></td>");
                                    //        html.Append("</tr>");
                                    //        html.Append("</tr>");
                                    //        html.Append("</table>");
                                    //        html.Append("</body>");
                                    ...
                                    //        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", user_rut.Email,
                                    //            "Thông báo tại GIANGHUY.COM.", html.ToString(), "");
                                    //    }
                                    //    catch { }
                                    //}
                                }
                    ...
                    else if (status == 3)
                    {
                        ...
                        if (user_rut != null)
                        {
                            ...
                            HistoryPayWalletController.Insert(uid_rut, username, 0, amount, "BQT Giang Huy đã hủy lệnh Rút tiền", newwallet, 2, 6, currentDate, username);
                            ...
                            if (setNoti != null)
                            {
                                if (setNoti.IsSentNotiUser == true)
                                {
                                    NotificationsController.Inser(user_rut.ID, user_rut.Username, 0, "BQT Giang Huy đã hủy lệnh rút tiền của bạn.", 3, currentDate, username, true);
                                    //string strPathAndQuery = Request.Url.PathAndQuery;
                                    //string strUrl = Request.Url.AbsoluteUri.Replace(strPathAndQuery, "/");
                                    //string datalink = "" + strUrl + "rut-tien/";
                                    //PJUtils.PushNotiDesktop(user_rut.ID, "BQT Giang Huy đã hủy lệnh rút tiền của bạn.", datalink);
                                }
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", user_rut.Email, "Thông báo tại GIANGHUY.COM.", "BQT Giang Huy đã hủy lệnh rút tiền của bạn.", "");
                                    }
                                    catch { }
                                }
                            }
