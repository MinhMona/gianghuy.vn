<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/manager/adminMasterNew.Master" CodeBehind="reportmanagersale.aspx.cs" Inherits="NHST.manager.reportmanagersale" %>
                                ...
                                <div class="cot-p">
                                    ...
                                    <div class="cot-ngang">
                                     ...
                                     <div class="cot-ngang">
                                        ...
                                        <div class="price">
                                            <asp:Literal runat="server" ID="ltrTienGiamGia"></asp:Literal>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table bordered highlight  ">
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width: 100px;">Tiền giảm giá</th>
