            ...
            if (id > 0)
            {
                ...
                if (o != null)
                {
                        ...
                        if (od != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", AccountController.GetByID(Convert.ToInt32(od.UID)).Email,
                                            "Thông báo tại GIANGHUY.COM", "Đơn hàng: " + MainOrderID + " có sản phẩm bị hết hàng.", "");
                                    }
                                    catch
                                    {
                    ...
                    else
                    {
                        ...
                        OrderController.UpdateQuantity(id, quantity.ToString());
                        OrderController.UpdateProductStatus(id, status);
                        OrderController.UpdatePricePriceReal(id, Convert.ToDouble(pProductPriceOriginal.Text).ToString(), Convert.ToDouble(pRealPrice.Text).ToString());
                        OrderController.UpdatePricePromotion(id,Convert.ToDouble(pProductPriceOriginal.Text).ToString());
                    }
                    OrderController.UpdateBrand(id, txtproducbrand.Text.Trim());
                }
            }
            ...
            if (mainorder != null)
            {
                ...
                if (listorder != null)
                {
                    if (listorder.Count > 0)
                    {
                        ...
                        double phuphi = Math.Round(Convert.ToDouble(mainorder.PhuPhiKhac), 0);
                        ...
                        double TotalPriceVND = FeeShipCN + FeeBuyPro
                                                ...
                                                + isFastPrice + pricevnd + InsuranceMoney - phuphi;
                        ...
                        totalo = pricepro + FeeCNShip + FeeBuyPros + FeeCheck + FeeWeight + IsFastDeliveryPrice - phuphi;
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGmail("gianghuycom@gmail.com.vn",
                                                "zioghzphiauqbdmw", AccountInfoController.GetByUserID(Convert.ToInt32(mainorder.UID)).Email,
                        ...
                        MainOrderController.UpdateFee_PhuPhiKhac(MainOrderID, newdeposit.ToString(), FeeCNShip.ToString(), FeeBuyPros.ToString(), FeeWeight.ToString(),
                        FeeCheck.ToString(), IsPackedPrice.ToString(), IsFastDeliveryPrice.ToString(), totalo.ToString(), phuphi.ToString());
