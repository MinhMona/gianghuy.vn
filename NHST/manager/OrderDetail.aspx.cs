...
using static NHST.danh_sach_don_hang;
...
namespace NHST.manager
{
    public partial class OrderDetail : System.Web.UI.Page
    {
        ...
        //                        double IsInsurancePrice = Math.Round(Convert.ToDouble(o.InsuranceMoney), 0);
        //                        double PhuPhiKhac = Math.Round(Convert.ToDouble(o.PhuPhiKhac), 0);
        ...
        public void loaddata()
        {
            ...
            if (id > 0)
            {
                ...
                if (o != null)
                {
                    ...
                    hdfPercentHHForSaleVisible.Value = "1";
                    chkIsCheckPrice.Value = Convert.ToBoolean(o.IsCheckNotiPrice).ToString();
                    ckPercentHHForSale.Value = Convert.ToBoolean(o.IsHHForSale).ToString();
                    ...
                    if (PayorderHistory.Count > 0)
                    {
                        ...
                        {
                            htmlPaid.Append("<tr>");
                            htmlPaid.Append("    <td>" + String.Format("{0:dd-MM-yyyy HH:mm:ss tt}", item.CreatedDate) + "</td>");
                    ...
                    if (obj_user != null)
                    {
                        ...
                        else if (RoleID == 6)
                        {
                            ...
                            pPacked.Enabled = false;
                            pShipHome.Enabled = false;
                            ltrBtnUpdateHHForSale.Text = "<a href=\"javascript:;\" class=\"btn mt-2\" onclick=\"UpdateHHForSale()\">CẬP NHẬT HOA HỒNG MẶC CẢ</a>";
                        ...
                        double phuphi = 0;
                        if (!string.IsNullOrEmpty(o.PhuPhiKhac))
                        {
                            phuphi = Math.Floor(Convert.ToDouble(o.PhuPhiKhac));
                            pPhuPhiCNY.Text = (phuphi / currency1).ToString();
                            pPhuPhiVND.Text = string.Format("{0:N0}", Convert.ToDouble(phuphi));
                            //lblShipTQ.Text = string.Format("{0:N0}", Convert.ToDouble(o.FeeShipCN));
                        }
                        ...
                        double tot = Convert.ToDouble(o.PriceVND) + fscn - realprice - phuphi;
                        ...
                        double alltotal = totalFee + Convert.ToDouble(o.PriceVND) + Convert.ToDouble(o.FeeShipCN) + Convert.ToDouble(o.FeeBuyPro) + Convert.ToDouble(o.FeeShipCNToVN)
                            + Convert.ToDouble(o.FeeWeight) + feeeinwarehouse + TotalFeeSupport - phuphi;
        ...
        protected void btnSend1_Click(object sender, EventArgs e)
        {
            ...
            //                    try
            //                    {
            //                        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn",
            //                            "zioghzphiauqbdmw",
                    ...
                    if (o != null)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                double OCurrent_PhuPhiKhac = 0;
                                if (o.PhuPhiKhac.ToFloat(0) > 0)
                                    OCurrent_PhuPhiKhac = Math.Round(Convert.ToDouble(o.PhuPhiKhac), 0);
                                ...
                                double PhuPhiKhac = Math.Round(Convert.ToDouble(pPhuPhiVND.Text), 0);

                                Math.Round(PhuPhiKhac, 0);
                                ...
                                if (IsInsurancePrice > 0)
                                {
                                    MainOrderController.UpdateInsurranceMoney(o.ID, IsInsurancePrice.ToString(), config1.InsurancePercent);
                                }
                                ...
                                if (OCurrent_deposit != Deposit)
                                {
                                    ...
                                    //try
                                    //{
                                    //    PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", AccountInfoController.GetByUserID(Convert.ToInt32(o.UID)).Email,
                                ...
                                if (OCurrent_PhuPhiKhac != PhuPhiKhac)
                                {
                                    //NotificationController.Inser(obj_user.ID, obj_user.Username, Convert.ToInt32(o.UID),
                                    //    AccountController.GetByID(Convert.ToInt32(o.UID)).Username, id, "Đã có cập nhật mới về tiền phí ship Trung Quốc cho đơn hàng #" + id + " của bạn. CLick vào để xem", 0,
                                    //    currentDate, obj_user.Username);
                                    ...
                                    //catch { }
                                    HistoryOrderChangeController.Insert(o.ID, obj_user.ID, obj_user.Username, obj_user.Username +
                                            " đã đổi tiền giảm giá của đơn hàng ID là: " + o.ID + ", từ " + string.Format("{0:N0}", OCurrent_PhuPhiKhac) + " sang "
                                            + string.Format("{0:N0}", PhuPhiKhac) + "", 2, currentDate);
                                }
                                ...
                                TotalPriceVND = TotalPriceVND - PhuPhiKhac;
                                TotalPriceVND = Math.Round(TotalPriceVND, 0);
                                MainOrderController.UpdateFee_PhuPhiKhac(o.ID, Deposit.ToString(), FeeShipCN.ToString(), FeeBuyPro.ToString(), FeeWeight.ToString(), IsCheckProductPrice.ToString(),
                                    IsPackedPrice.ToString(), IsFastDeliveryPrice.ToString(), TotalPriceVND.ToString(), PhuPhiKhac.ToString());
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw",
                                                accmuahan.Email,
                                                "Thông báo tại GIANGHUY.COM.", "Đơn hàng " + o.ID
                                                + " đã được mua hàng.", "");
                                        }
                                        catch { }
                                    }
                            ...
                            foreach (var item in listCheck)
                            {
                                if (!string.IsNullOrEmpty(item))
                                {
                                    ...
                                    if (ck != null)
                                    {
                                        ...
                                        if (ck[0] == "8")
                                        {
                                            hasHHMacCa = Convert.ToBoolean(ck[1].ToInt(0));
                                        }
                                    }
                                }
                            }
                            ...
                            if (status == 4)
                            {
                                if (o.DateShopPhatHang == null)
                                {
                                    MainOrderController.UpdateDateShop(o.ID, currentDate);
                                }
                            }
                            else if (status == 5)
                            {
                            ...
                            {
                                if (o.DateDangVeVN == null)
                                {
                                    MainOrderController.UpdateDateDangVeVN(o.ID, currentDate);
                                }
                            }
                            else if (status == 10)
                            {
                            ...
                            switch (obj_user.RoleID)
                            {
                                case 0:
                                case 2:
                                    MainOrderController.UpdateIsHHForSale(o.ID, hasHHMacCa, currentDate, obj_user.ID);
                                    break;
                                //case 6:
                            ...
                            double IsInsurancePrice1 = 0;
                            if (txtInsuranceMoney.Text.ToString().ToFloat(0) > 0)
                                IsInsurancePrice1 = Math.Round(Convert.ToDouble(txtInsuranceMoney.Text), 0);
                            if (baohiem == false)
                            {
                            ...
                            {
                                double InsurranceMoney = Convert.ToDouble(o.PriceVND) * (Convert.ToDouble(config1.InsurancePercent) / 100);
                                MainOrderController.UpdateInsurranceMoney(o.ID, InsurranceMoney.ToString(), config1.InsurancePercent);
                            }

                            if (IsInsurancePrice1 > 0)
                            {
                                MainOrderController.UpdateInsurranceMoney(o.ID, IsInsurancePrice1.ToString(), config1.InsurancePercent);
                            }
                            ...
                            if (mo != null)
                            {
                                ...
                                if (config != null)
                                {
                                    ...
                                    hhforSalePercent = Convert.ToDouble(config.HHForSalePercent);
                                }
                                string salerName = "";
                                string dathangName = "";
                                            ...
                                            if (staffstatus == 1)
                                            {
                                                ...
                                                if (sale != null)
                                                {
                                                    ...
                                                    if (d > 90)
                                                    {
                                                        ...
                                                        double hhKhongtMacCa = feebp * salepercentaf3m / 100;
                                                        double hhMacCa = 0;
                                                        if (hasHHMacCa)
                                                            hhMacCa = (totalpriceloi * dathangpercent / 100) * hhforSalePercent / 100;
                                                        double per = Math.Round(hhKhongtMacCa + hhMacCa, 0);
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        double hhKhongtMacCa = feebp * salepercent / 100;
                                                        double hhMacCa = 0;
                                                        if (hasHHMacCa)
                                                            hhMacCa = (totalpriceloi * dathangpercent / 100) * hhforSalePercent / 100;
                                                        double per = Math.Round(hhKhongtMacCa + hhMacCa, 0);
                                        ...
                                        if (staff != null)
                                        {
                                            if (staff.Status == 1)
                                            {
                                                ...
                                                if (totalRealPrice > 0)
                                                {
                                                    ...
                                                    if (hasHHMacCa)
                                                        income = Math.Round(income * (100 - hhforSalePercent) / 100, 0);
        ...
        protected void btnUpdateHHForSale_Click(object sender, EventArgs e)
        {
            if (!Page.IsValid) return;
            string username = Session["userLoginSystem"].ToString();
            var obj_user = AccountController.GetByUsername(username);
        ...
        protected void btnStaffUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (mo != null)
            {
                ...
                int salerID_old = Convert.ToInt32(mo.SalerID);
                int dathangID_old = Convert.ToInt32(mo.DathangID);
                bool hasHHMacCa = mo.IsHHForSale ?? false;
                #region Saler
                if (SalerID > 0)
                {
                    double totalPrice = Convert.ToDouble(mo.PriceVND) + Convert.ToDouble(mo.FeeShipCN) - Convert.ToDouble(mo.PhuPhiKhac);
