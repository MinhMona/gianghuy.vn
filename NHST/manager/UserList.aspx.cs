...
namespace NHST.manager
{
    public partial class UserList1 : System.Web.UI.Page
    {
        ...
        {           
            ...
            StrExport.Append("      <th><strong>Nhân viên sale</strong></th>");
            ...
            foreach (var item in la)
            {
                ...
                StrExport.Append("      <td>Khách hàng</td>");
        ...
        public void LoadData()
        {
            ...
            var la = AccountController.GetListUserBySQL_Thang(search, page, 10);
            int total = AccountController.GetTotalUser_Thang(search);
            pagingall(la, total);
        }
        ...
        public void pagingall(List<View_UserList> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    hcm.Append("<td>" + "¥ " + Math.Round(Convert.ToDouble(item.WalletCYN), 2) + "</td>");
