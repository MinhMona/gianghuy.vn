    ...
    public partial class HistorySendWallet1 : System.Web.UI.Page
    {
        ...
        public void pagingall(List<AdminSendUserWalletController.ListShowNew> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                {
                    var item = acs[i];
                    if (item.IsLoan == true && item.IsPayLoan != true)
                    ...
                    if (Convert.ToBoolean(item.IsLoan))
                        hcm.Append("<td><label><input type=\"checkbox\" checked disabled =\"\" ><span ></span ></label></td>");
                    else
                        hcm.Append("<td><label><input type=\"checkbox\" disabled =\"\" ><span ></span ></label></td>");

                    if (Convert.ToBoolean(item.IsPayLoan))
                        hcm.Append("<td><label><input type=\"checkbox\" checked disabled =\"\" ><span ></span ></label></td>");
                    else
                        hcm.Append("<td><label><input type=\"checkbox\" disabled =\"\" ><span ></span ></label></td>");
                                    ...
                                    if (setNoti != null)
                                    {
                                        if (setNoti.IsSendEmailUser == true)
                                        {
                                            try
                                            {
                                                ...
                                                PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", user_wallet.Email,
                                                                        "GIANGHUY.COM THÔNG BÁO NẠP VÍ THÀNH CÔNG",
                                                                        html.ToString(), "");
