                ...
                if (user != null)
                {
                    ...
                    if (userRole == 0 || userRole == 2 || userRole == 4)
                    {
                        ...
                        if (packages.Count > 0)
                        {
                            ...
                            {
                                var re = RequestOutStockController.CheckIsInRequestOutStock(package.ID);

                                if (package.Status == 4 || re)
                                    continue;
                                ...
                                if (mainorder != null)
                                {
                                    ...
                                    if (smallpackages.Count > 0)
                                    {
                                        ...
                                        if (isChuaVekhoTQ == false)
                                        {
                                            ...
                                            //                             "Thông báo tại GIANGHUY.COM.", "Hàng của đơn hàng " + MainorderID + " đã về kho TQ.", "");
                                            //                     }
                                            //                     catch { }
                                            //                 }
                                            //             }
                    ...
                    if (mainorder != null)
                    {
                        ...
                        if (smallpackage.Count > 0)
                        {
                            ...
                            foreach (var item in smallpackage)
                            {
                                ...
                                {
                                    totalWeightTT = (pDai * pRong * pCao) / 7000;
                                }
                            ...
                            foreach (var item in smallpackage)
                            {
                                ...
                                if (pDai > 0 && pRong > 0 && pCao > 0)
                                {
                                    weigthTT = (pDai * pRong * pCao) / 7000;
                                }
                                weigthTT = Math.Round(weigthTT, 1);
                        ...
                        double TotalPriceVND = FeeShipCN + FeeBuyPro + FeeWeight + IsCheckProductPrice + IsPackedPrice
                                                     + IsFastDeliveryPrice + isfastprice + pricenvd + InsuranceMoney - phuphi;
                        TotalPriceVND = Math.Round(TotalPriceVND, 0);
                        MainOrderController.UpdateFee_PhuPhiKhac(mainorder.ID, Deposit.ToString(), FeeShipCN.ToString(), FeeBuyPro.ToString(), FeeWeight.ToString(),
                            IsCheckProductPrice.ToString(),
                            IsPackedPrice.ToString(), IsFastDeliveryPrice.ToString(), TotalPriceVND.ToString(), phuphi.ToString());
                        ...
                        if (transportation != null)
                        {
                            ...
                            if (packages.Count > 0)
                            {
                                foreach (var p in packages)
                                {
                                    ...
                                    if (p.Status >= 3)
                                    {
                                        double totalWeightCN = Math.Round(Convert.ToDouble(p.Weight), 5);
                                        double totalWeightTT = 0;
