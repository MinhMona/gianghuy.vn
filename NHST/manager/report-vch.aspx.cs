            ...
            if (acc != null)
            {
                ...
                if (r.Count > 0)
                {
                    ...
                    foreach (var item in r)
                    {
                        ...
                        t.TotalPrice = string.Format("{0:N0}", item.TotalPriceVND);
                        ...
                        t.Note = item.Note;
                        t.FeeInsurrance = string.Format("{0:N0}", item.FeeInsurrance);
        ...
        public void pagingall(List<ReportTrans> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    hcm.Append("<p class=\"s-txt no-wrap\"><span class=\"total\">Tổng số kiện:</span><span> " + item.TotalPackages + " Kiện</span></p>");
                    hcm.Append("<p class=\"s-txt no-wrap\"><span class=\"total\">Tổng cân nặng:</span><span> " + item.TotalWeight + " Kg</span></p>");
                    hcm.Append("</td>");
                    hcm.Append("<td style=\"font-weight:bold\">");
                    hcm.Append("<p class=\"s-txt blue-text no-wrap\"><span class=\"total\">Tổng bảo hiểm:</span><span> " + item.FeeInsurrance + "</span></p>");
                    hcm.Append("<p class=\"s-txt red-text no-wrap\"><span class=\"total\">Tổng thanh toán:</span><span> " + item.TotalPrice + "</span></p>");
                    hcm.Append("</td>");
                    ...
                    if (item.Status != 2)
                    {
                        ...
                        if (a.RoleID == 0)
                        {
                            ...
                            hcm.Append("<a href =\"javascript:;\" onclick=\"Delete($(this),'" + item.ID + "')\" data-position=\"top\" ><i class=\"material-icons\">delete</i><span>Hủy thống kê</span></a>");
                        }
                    }
                    else
                    {
                    ...
                    if (id > 0)
                    {
                        ...
                        if (ots != null)
                        {
                            ...
                            if (acc != null)
                            {
                                ...
                                html += "   <div class=\"top\">";
                                html += "       <div class=\"left\">";
                                html += "           <span class=\"company-info\">GIANGHUY.COM</span>";
