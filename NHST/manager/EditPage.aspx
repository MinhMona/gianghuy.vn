<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="EditPage.aspx.cs" Inherits="NHST.manager.EditPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div>
                        <div class="row">
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" ID="txtTitle" type="text" class="validate" required></asp:TextBox>
                            ...
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" ID="txtLink" type="text" class="validate" disabled></asp:TextBox>
                                <label for="txtLink"><span class="red-text">*</span> Link: </label>
                                <span class="helper-text" data-error="Vui lòng nhập đường dẫn"></span>
                            </div>
                            <div class="input-field col s12">
                                <asp:ListBox runat="server" name="" ID="lbChuyenMuc"></asp:ListBox>
                                <label>Chuyên mục:</label>
                            </div>
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" ID="txtShortDescription" type="text" TextMode="MultiLine" Width="100%" Height="150px" class="validate" data-type="text-only"></asp:TextBox>
    ...
    <script>
        ...
        function myFunction() {
            ...
            var a = $('#<%=hdfStatus.ClientID%>').val();
            if (a == 0) {
                $('#<%=txtStatus.ClientID%>').prop('checked', false);

            }
            else {
                $('#<%=txtStatus.ClientID%>').prop('checked', true);

            }

            var b = $('#<%=hdfSideBar.ClientID%>').val();
            if (b == 0) {
        ...
        $(document).ready(function () {
            tinymce.init({
                ...
                menubar: false,
                oninit: "setPlainText",
                plugins: "paste imagetools media link table code",
                paste_as_text: true,
                inline: false,
                relative_urls: false,
