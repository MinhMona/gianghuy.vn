        ...
        public void LoadData()
        {
            ...
            if (id > 0)
            {
                ...
                if (re != null)
                {
                    ...
                    txtTotalPriceVND.Text = Convert.ToDouble(re.TotalPriceVND).ToString();
                                        ...
                                        if (walletCYN >= TotalPrice)
                                        {
                                           ...
                                           8, currentDate, ac.Username, true);
                                                        ...
                                                        if (setNoti.IsSendEmailUser == true)
                                                        {
                                                            try
                                                            {
                                                                PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", usend.Email,
                    ...
                    else
                    {
                       ...
                       8, currentDate, ac.Username, true);
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        ...
                                        {
                                            PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", usend.Email,
                                                "Thông báo tại GIANGHUY.COM.", "Đơn thanh toán hộ: " + ID + "  của bạn đã hoàn thành.", "");
                                        }
                                        catch { }
                                    }
                                }
