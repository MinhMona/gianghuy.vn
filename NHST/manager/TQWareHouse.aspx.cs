                ...
                if (user != null)
                {
                    ...
                    if (userRole == 0 || userRole == 2 || userRole == 4)
                    {
                        ...
                        if (packages.Count > 0)
                        {
                            ...
                            if (mainOrderCount > 0 && transOrderCount == 0)
...
"0", "0", "0", 0, ordertransaction, 1, Description, "", "0", "0", DateTime.Now, username, KhoTQ.ToInt(0), KhoVN.ToInt(0), PTVC.ToInt(0));
                                                int packageID = 0;
