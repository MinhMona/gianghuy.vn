                                ...
                                try
                                {
                                    ...
                                    if (check != null)
                                    {
                                        ...
                                        if (package != null)
                                        {
                                            ...
                                            if (mainorder != null)
                                            {
                                                ...
                                                SmallPackageController.Update_Thang(check.ID,
                                                       baolon, drRow["MaVanDon"].ToString(), "", 0, 0, 0, 2, "", DateTime.Now, username_current);
                                    ...
                                    else if (check == null)
                                    {
                                        string packageID = SmallPackageController.InsertWithMainOrderIDAndIsTemp(MainOrderID,
                                                baolon, drRow["MaVanDon"].ToString(), "", 0, 0, 0, 2, true, 0, DateTime.UtcNow.AddHours(7), username_current);
                                    }
                                    else
                                    {
                                        checkMVD += drRow["MaVanDon"].ToString() + " - ";
