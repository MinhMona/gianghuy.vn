...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12 l3">
                                            <asp:ListBox runat="server" SelectionMode="Multiple" class="select_all" ID="ddlStatus">
                                                ...
                                                <asp:ListItem Value="4">Shop phát hàng</asp:ListItem>
                                                <asp:ListItem Value="6">Đã về kho TQ</asp:ListItem>
                                                <asp:ListItem Value="8">Đang vận chuyển về VN</asp:ListItem>
                                        ...
                                        <div class="input-field col s12 l3">
                                            <label>
                                                <asp:TextBox Enabled="true" ID="cbDatHang" unchecked runat="server" type="checkbox" /><span id="lbCheckBoxOrder">Đơn không có nhân viên đặt hàng</span></label>
                                            <asp:HiddenField runat="server" ID="hdfCheckBoxOrder" Value="0" />
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('#lbCheckBoxOrder').click(function () {
            if ($('#<%=hdfCheckBoxOrder.ClientID%>').val() / 2 == 0) {
                $('#<%=hdfCheckBoxOrder.ClientID%>').val('1');
            }
            else {
                $('#<%=hdfCheckBoxOrder.ClientID%>').val('0');
            }
        })
        ...
        $(document).ready(function () {
            ...
            if ($('#<%=hdfCheckBoxOrder.ClientID%>').val() == 0) {

                $('#<%=cbDatHang.ClientID%>').prop("checked", false);
            }
            else {
                $('#<%=cbDatHang.ClientID%>').prop("checked", true);
            }
        });
