    ...
    public partial class ComplainList1 : System.Web.UI.Page
    {
        ...
        public static string loadinfoComplain(string ID)
        {
            ...
            if (com != null)
            {
                ...
                if (com != null)
                {
                    ...
                    var payHelp = PayhelpController.GetByID(Convert.ToInt32(com.OrderID));
                    if (ordershop != null)
                    {
        ...
        public void pagingall(List<tbl_Complain> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                {
                    var item = acs[i];
                    var mainOrder = MainOrderController.GetByID(Convert.ToInt32(item.OrderID));
                    var payHelp = PayhelpController.GetByID(Convert.ToInt32(item.OrderID));
                    string statusString = "";
                    if (item.Status == 0)
                    ...
                    if (mainOrder != null)
                        ...
                        hcm.Append("<a href =\"chi-tiet-thanh-toan-ho.aspx?ID=" + item.OrderID + "\" target=\"_blank\" data-position=\"top\" ><i class=\"material-icons\">edit</i><span>Chi tiết đơn</span></a>");
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw",
                                                u.Email, "Thông báo tại GIANGHUY.COM.", "Admin đã hủy khiếu nại đơn hàng: "
                                                + com.OrderID + "  của bạn.", "");
                                        }
                                        catch { }
                                    }
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            var la = ComplainController.GetAllBySQLExcel(search, fd, td, status);
            ...
            string strFile = "ExcelComplainList.xls";
