                    ...
                    if (userRole == 0 || userRole == 2 || userRole == 5)
                    {
                                ...
                                foreach (var item in smallpackages)
                                {
                                    ...
                                    if (mID > 0)
                                    {
                                        ...
                                        if (mainorder != null)
                                        {
                                            ...
                                            si.UID = UID;
                                            var warehouse = WarehouseController.GetByID(Convert.ToInt32(mainorder.ReceivePlace));
                        ...
                        else
                        {
                            ...
                            if (smallpackages.Count > 0)
                            {
                                foreach (var item in smallpackages)
                                {
                                    var re = RequestOutStockController.CheckIsInRequestOutStock(item.ID);
                        ...
                        int warehouseFrom = Convert.ToInt32(mainorder.FromPlace);
                            ...
                            if (packages.Count > 0)
                            {
                                foreach (var p in packages)
                                {
                                    ...
                                    {
                                        totalweight += Math.Round(Convert.ToDouble(p.Weight), 5);
                                    }
                                }
                            }
                            ...
                            if (smallpackage.Count > 0)
                            {
                                ...
                                foreach (var item in smallpackage)
                                {
                                    ...
                                    {
                                        compareSize = (pDai * pRong * pCao) / 7000;
                                    }
                            ...
                            double TotalPriceVND = FeeShipCN + FeeBuyPro + FeeWeight + IsCheckProductPrice + IsPackedPrice
                                                         + IsFastDeliveryPrice + isfastprice + pricenvd + TotalFeeSupport + InsuranceMoney - phuphi;
