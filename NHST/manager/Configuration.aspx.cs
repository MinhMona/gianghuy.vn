    ...
    public partial class Configuration : System.Web.UI.Page
    {
        ...
        public void loaddata()
        {
            ...
            if (c != null)
            {
                ...
                txtInsurranceTrans.Text = c.InsurancePercentTrans;
                txtSaleIncomeTrans.Text = c.SalePercentTrans;
                ...
                txtHHForSalePercent.Text = c.HHForSalePercent.ToString();
                ...
                pFeeService.Text = c.MinFeeService.ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (c != null)
            {
                ...
                var kq = ConfigurationController.UpdateVer2(c.ID, txtWebName.Text, txtEmailSupport.Text, txtEmailContact.Text, txtHotline.Text, hdfAddress1.Value.ToString(), txtFacebook.Text, txtTwitter.Text, txtGooglePlus.Text, txtInstagram.Text, txtSkype.Text,
                    ...
                    txtInsurancePercent.Text, txtHeaderScript.Text, txtFooterScript.Text, txtCompanyShortName.Text, txtCompanyLongName.Text, txtCompanyName.Text, IMG, txtTaxCode.Text, rAgentCurrency.Text, rPriceCheckOutWareDefault.Text, txtSaleIncomeTrans.Text, txtInsurranceTrans.Text,
                    Convert.ToDouble(pFeeService.Text), Convert.ToDouble(txtHHForSalePercent.Text));
