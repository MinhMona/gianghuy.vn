    ...
    public partial class chi_tiet_vch : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (t != null)
            {
                ...
                TransportationOrderNewController.UpdateNew(ID, t.ID, t.Username, rWeight.Value.ToString(), currency.ToString(),
                ...
                SmallPackageController.UpdateUIDandUserName(Convert.ToInt32(t.SmallPackageID), t.ID, t.Username);
