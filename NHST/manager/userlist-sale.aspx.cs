...
{
    public partial class userlist_sale : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                var la = AccountController.GetAll_ViewUserListExcel_Saler("", id).Where(u => u.RoleID == 1).ToList();
        ...
        public void LoadData()
        {
            ...
            if (id > 0)
            {
                ...
                {
                    searchid = Request.QueryString["id1"].ToString().Trim();
                    search_name.Text = searchid;
                }
                string search = "";
                ...
                var la = AccountController.GetListUserBySQL_listSaler(id, search, searchid, page, 10);
                int total = AccountController.GetTotalUser_ListSaler(id, search, searchid);
                pagingall(la, total);
            }
        }
        ...
        {
            string searchid = search_name.Text.Trim();
            ...
            {
                Response.Redirect("userlist?id1=" + searchid + "");
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string id = AccountController.Insert(nickname, Email, txt_Password.Text.Trim(), RoleID, LevelID, VIPLevel,
                Convert.ToInt32(ddlStatus.SelectedValue), SaleID, 0, DateTime.Now, Username, DateTime.Now, Username, Token);
