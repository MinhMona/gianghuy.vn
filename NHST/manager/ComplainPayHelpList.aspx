<%@ Page Title="Khiếu nại thanh toán hộ" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="ComplainPayHelpList.aspx.cs" Inherits="NHST.manager.ComplainPayHelpList1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Khiếu nại đơn thanh toán hộ</h4>
                    <asp:Button runat="server" Style="float: right;" ID="btnExcel" Text="Xuất Excel" CssClass="btn primary-btn" UseSubmitBehavior="false" OnClick="btnExcel_Click" />
                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" ID="txtAmountRefundCYN" type="text" class="validate" value="100.000.000"></asp:TextBox>
                                <label for="rp_yuan">Số tiền (¥)</label>
                            </div>
                            <div class="input-field col s12">
    ...
    <script>
        ...
        function Complain(ID) {
            ...
            $.ajax({
                type: "POST",
                url: "/manager/ComplainPayHelpList.aspx/loadinfoComplainPayHelp",
                data: '{ID: "' + ID + '"}',
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=txtAmountRefundCYN.ClientID%>').val(data.AmountVND);
