        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">CẤU HÌNH HỆ THỐNG GIANGHUY.COM</h4>
                    ...
                    <div class="col s12 m12 l4 sticky-wrap">
                        <div class="hide-on-small-only card-panel">
                            <ul class="table-of-contents ">
                                ...
                                <li style="display:none"><a href="#footer-sec">Cấu hình Footer</a></li>
                            ...
                            <div id="value-sec" class="section scrollspy fee-order">
                                ...
                                <div class="child-fee">
                                    <div class="content-panel">
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phần trăm hoa hồng mặc cả cho nhân viên sale</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" placeholder="" type="number" ID="txtHHForSalePercent"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phần trăm bảo hiểm ký gửi</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" placeholder="" type="number" ID="txtInsurranceTrans" value="0"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phần trăm hoa hồng sale ký gửi</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" placeholder="" type="number" ID="txtSaleIncomeTrans" value="0"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="order-row">
                                            <div class="left-fixed">
                                                <p class="txt">Phí dịch vụ thấp nhất</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" placeholder="" type="number" ID="pFeeService" value="0"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
