            ...
            if (package != null)
            {
                ...
                else
                {
                    ...
                    if (transportation != null)
                    {
                        ...
                        if (transportation.IsInsurrance == true)
                        {
                            if (Convert.ToDouble(transportation.InsurrancePrice) > 0)
                            {
                                TienBaoHiem = Convert.ToDouble(transportation.InsurrancePrice);
                            }
                        }

                        double totalPriceVND = finalPriceOfPackage + additionfeeVND + sensorVND + TienBaoHiem;
                        ...
                        if (transportation.DateInVNWareHouse == null)
                        {
