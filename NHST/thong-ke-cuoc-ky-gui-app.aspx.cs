        ...
        public void pagingall(List<tbl_ExportRequestTurn> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    html.Append(" <div class=\"flex-justify-space\">");
                    html.Append(" <p class=\"gray-txt\">Tổng số cân:</p>");
                    html.Append("  <p>" + item.TotalWeight + "</p>");
                    html.Append(" </div>");


                    html.Append(" <div class=\"flex-justify-space\">");
                    html.Append(" <p class=\"gray-txt\">Tổng tiền bảo hiểm:</p>");
                    html.Append("  <p>" + string.Format("{0:N0}", item.FeeInsurrane) + "</p>");
                    html.Append(" </div>");

                    html.Append(" <div class=\"flex-justify-space\">");
                    html.Append(" <p class=\"gray-txt\">Tổng tiền cần thanh toán:</p>");
                    html.Append("  <p>" + string.Format("{0:N0}", item.TotalPriceVND) + " đ</p>");
                    html.Append(" </div>");
                    ...
                    html.Append("   <p>" + PJUtils.ReturnStatusTT(Convert.ToInt32(item.Status)) + "</p>");
                    html.Append(" </div>");

                    html.Append(" <div class=\"flex-justify-space\">");
                    html.Append("     <p class=\"gray-txt\">Trạng thái XK:</p>");
                    html.Append("   <p>" + PJUtils.ReturnStatusXK(Convert.ToInt32(item.StatusExport)) + "</p>");
                    html.Append(" </div>");
