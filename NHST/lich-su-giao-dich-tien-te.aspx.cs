...
namespace NHST
{
    public partial class lich_su_giao_dich_tien_te1 : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (u != null)
            {
                int UID = u.ID;
                ViewState["UID"] = UID;
                lblAccount.Text = "¥ " + Convert.ToDouble(u.WalletCYN) + "";
        ...
        public void pagingall(List<tbl_HistoryPayWalletCYN> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                {                   
                    ...
                    html.Append(" <td><span>" + item.Note + "</span></td>");     
                    html.Append(" <td><span>" + symbol + " ¥ " + amount + " </span></td>");
                    html.Append(" <td><span>" + PJUtils.GetTradeTypeCYN(Convert.ToInt32(item.TradeType)) + "</span></td>");                                 
                    html.Append("<td><span>¥ " + string.Format("{0:N0}", moneyleft) + "</span></td>");
                    html.Append("</tr>");
                }
