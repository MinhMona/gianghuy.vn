...
namespace NHST
{
    ...
    public class WebService1 : System.Web.Services.WebService
    {
        ...
        {
            //return property;
            List<Saler> sale = new List<Saler>();
            var salers = AccountController.GetAllByRoleIDStatus(6);
            if (salers.Count > 0)
            {
                foreach (var item in salers)
                {
                    Saler s = new Saler();
                    s.SaleID = Convert.ToInt32(item.ID);
                    s.SaleName = item.Username;
                    sale.Add(s);
                }
            }
            var rs = new ResponseClass();
        ...
        public void receivesmallpackage(string MainOrderCode, string Value, string Type) //1-taobao; 2-tmall; 3-1688
        {
            ...
            if (HttpContext.Current.Session["userLoginSystem"] != null)
            {
                ...
                else
                {
                    ...
                    rs.Message = "https://gianghuy.com/dang-nhap";
                }
            }
            else
            {
            ...
            if (ac != null)
            {
                if (ac.RoleID == 1)
                {
                    if (ac.Status == 2)
                    {
                        ...
                        m1.Link = "https://gianghuy.com/diem-tich-luy-app.aspx?UID=";
                        menu.Add(m1);
                        acc.Menu = menu;
                                    ...
                                    if (goshop != null)
                                    {
                                        if (goshop.IsCheckProduct == true)
                                        {
                                            ...
                                            if (listpro.Count > 0)
                                            {
                                                ...
                                                if (counpros > 0)
                                                {
                                                    if (counpros >= 1 && counpros <= 5)
                                                    {
                                                        total = total + (7000 * counpros);
                                                    }
                                                    else if (counpros > 5 && counpros <= 20)
                                                    {
                                                        total = total + (5000 * counpros_more10);
                                                    }
                                                    else if (counpros > 20 && counpros <= 50)
                                                    {
                                                        total = total + (3000 * counpros);
                                                    }
                                                    else if (counpros > 50 && counpros <= 200)
                                                    {
                                                        total = total + (2000 * counpros);
                                                    }
                                                    else if (counpros > 200)
                                                    {
                ...
                if (obj_user != null)
                {
                    ...
                    if (oshops != null)
                    {
                        ...
                        string kq = MainOrderController.Insert(UID, ShopID, ShopName, Site, IsForward, IsForwardPrice, IsFastDelivery, IsFastDeliveryPrice, IsCheckProduct, IsCheckProductPrice,
                            IsPacked, IsPackedPrice, IsFast, IsFastPrice, pricepro.ToString(), PriceCNY, FeeShipCN, FeeBuyPro, FeeWeight, Note, FullName, Address, Email, Phone, Status, Deposit, CurrentCNYVN,
                                        ...
                                        foreach (var admin in admins)
                                        {
                                            try
                                            {
                                                PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", admin.Email,
                                                    "Thông báo tại Giang Huy.", "Có đơn hàng mới ID là: " + idkq, "");
                        ...
                        if (salerID > 0)
                        {
                            ...
                            if (sale != null)
                            {
                                ...
                                if (setNoti.IsSentNotiAdmin == true)
                                {
                                    NotificationsController.Inser(sale.ID, sale.Username, idkq, "Có đơn hàng mới ID là: " + idkq,
                                    1, CreatedDate, obj_user.Username, false);
                                }
                            }
                        }
                        if (dathangID > 0)
                        {
                            ...
                            if (dathang != null)
                            {
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    //    try
                                    //    {
                                    //        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", dathang.Email,
                                    //                 "Thông báo tại Giang Huy.", "Có đơn hàng mới ID là: " + idkq, "");
                                    //    }
                                    //    catch { }
                                    //}
        ...
        [WebMethod]
        [ScriptMethod(UseHttpGet = false, ResponseFormat = ResponseFormat.Json)]
        public void Register(string FirstName, string LastName, string Address, string Phone, string Email, string BirthDay, int Gender, string UserName, string Password, string ConfirmPassword, int SaleID, int warehouseFromId, int warehouseId, int shippingTypeId)
        {
            var rs = new ResponseClass();
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        AccountController.UpdateScanWareHouse(id.ToInt(0), warehouseFromId, warehouseId);
                        AccountController.UpdateShippingType(id.ToInt(0), shippingTypeId);
        ...
        public void ForgotPassword(string Email)
        {
            ...
            if (user != null)
            {
                ...
                if (tk != null)
                {
                    string link = "<a href=\"https://gianghuy.com/mat-khau-moi.aspx?token=" + token + "\">đây</a>";
                    try
                    {
                        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", Email.Trim(), "Reset Mật khẩu trên GIANGHUY.COM", "Vui lòng nhấn vào: <strong>" + link + "</strong> để thiết lập lại mật khẩu. Link chỉ sử dụng được 1 lần.", "");
                    }
                    catch
                    {
        ...
        public void GetAllMenu(int UID, string Key)
        {
            ...
            m1.GroupID = 0;
            m1.Parent = 0;
            m1.Link = "https://gianghuy.com/home-app.aspx?UID=";
            m1.ShowType = 1;
            m1.Icon = "https://gianghuy.com/App_Themes/App/images/ic_home.png";
            mn.Add(m1);
            ...
            m2.GroupID = 0;
            m2.Parent = 0;
            m2.Link = "https://gianghuy.com/Tracking-app.aspx?UID=";
            m2.Icon = "https://gianghuy.com/App_Themes/App/images/ic_search.png";
            m2.ShowType = 1;
            mn.Add(m2);
            ...
            m3.Parent = 0;
            m3.Link = "";
            m3.Icon = "https://gianghuy.com/App_Themes/App/images/ic_buy.png";
            m3.ShowType = 1;
            mn.Add(m3);
            ...
            m5.GroupID = 1;
            m5.Parent = 1;
            m5.Link = "https://gianghuy.com/dat-hang-ngoai-he-thong-app.aspx?UID=";
            m5.Icon = "";
            m5.ShowType = 1;
            mn.Add(m5);
            ...
            m6.GroupID = 1;
            m6.Parent = 1;
            m6.Link = "https://gianghuy.com/don-hang-app.aspx?UID=";
            m6.Icon = "";
            m6.ShowType = 1;
            mn.Add(m6);
            ...
            m7.GroupID = 1;
            m7.Parent = 1;
            m7.Link = "https://gianghuy.com/danh-sach-don-hang-khac-app.aspx?UID=";
            m7.Icon = "";
            m7.ShowType = 1;
            mn.Add(m7);
            ...
            m8.Parent = 0;
            m8.Link = "";
            m8.Icon = "https://gianghuy.com/App_Themes/App/images/ic_truck.png";
            m8.ShowType = 1;
            mn.Add(m8);
            ...
            m20.GroupID = 2;
            m20.Parent = 1;
            m20.Link = "https://gianghuy.com/tao-ma-van-don-ky-gui-app.aspx?UID=";
            m20.Icon = "";
            m20.ShowType = 1;
            mn.Add(m20);
            ...
            m9.GroupID = 2;
            m9.Parent = 1;
            m9.Link = "https://gianghuy.com/danh-sach-kien-ky-gui-app.aspx?UID=";
            m9.Icon = "";
            m9.ShowType = 1;
            mn.Add(m9);
            ...
            m25.GroupID = 2;
            m25.Parent = 1;
            m25.Link = "https://gianghuy.com/thong-ke-cuoc-ky-gui-app.aspx?UID=";
            m25.Icon = "";
            m25.ShowType = 1;
            mn.Add(m25);
            ...
            m10.Parent = 0;
            m10.Link = "";
            m10.Icon = "https://gianghuy.com/App_Themes/App/images/ic_dollar.png";
            m10.ShowType = 1;
            mn.Add(m10);
            ...
            m11.GroupID = 3;
            m11.Parent = 1;
            m11.Link = "https://gianghuy.com/tao-don-thanh-toan-ho-app.aspx?UID=";
            m11.Icon = "";
            m11.ShowType = 1;
            mn.Add(m11);
            ...
            m12.GroupID = 3;
            m12.Parent = 1;
            m12.Link = "https://gianghuy.com/thanh-toan-ho-app.aspx?UID=";
            m12.Icon = "";
            m12.ShowType = 1;
            mn.Add(m12);
            ...
            m13.Parent = 0;
            m13.Link = "";
            m13.Icon = "https://gianghuy.com/App_Themes/App/images/ic_wallet.png";
            m13.ShowType = 1;
            mn.Add(m13);
            ...
            m14.GroupID = 4;
            m14.Parent = 1;
            m14.Link = "https://gianghuy.com/lich-su-giao-dich-app.aspx?UID=";
            m14.Icon = "";
            m14.ShowType = 1;
            mn.Add(m14);
            ...
            m15.GroupID = 4;
            m15.Parent = 1;
            m15.Link = "https://gianghuy.com/lich-su-giao-dich-tien-te-app.aspx?UID=";
            m15.Icon = "";
            m15.ShowType = 1;
            mn.Add(m15);
            ...
            m16.GroupID = 4;
            m16.Parent = 1;
            m16.Link = "https://gianghuy.com/nap-tien-app.aspx?UID=";
            m16.Icon = "";
            m16.ShowType = 1;
            mn.Add(m16);
            ...
            m18.GroupID = 4;
            m18.Parent = 1;
            m18.Link = "https://gianghuy.com/rut-tien-te-app.aspx?UID=";
            m18.Icon = "";
            m18.ShowType = 1;
            mn.Add(m18);
            ...
            m17.GroupID = 4;
            m17.Parent = 1;
            m17.Link = "https://gianghuy.com/rut-tien-app.aspx?UID=";
            m17.Icon = "";
            m17.ShowType = 1;
            mn.Add(m17);
            ...
            m19.GroupID = 0;
            m19.Parent = 0;
            m19.Link = "https://gianghuy.com/khieu-nai-app.aspx?UID=";
            m19.Icon = "https://gianghuy.com/App_Themes/App/images/ic_mark.png";
            m19.ShowType = 1;
            mn.Add(m19);
                ...
                if (u != null)
                {
                    ...
                    if (lNotiSingle.Count > 0)
                    {
                        foreach (var item in lNotiSingle)
                        {
                            ...
                            if (item.NotifType == 1)
                            {
                                n.Link = "https://gianghuy.com/chi-tiet-don-hang-app.aspx?UID=" + UID + "&OrderID=" + item.OrderID + "&Key=" + Key + "";
                                n.Type = 1;
                            }
                            if (item.NotifType == 2)
                            {
                                n.Link = "https://gianghuy.com/lich-su-giao-dich-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 1;
                            }
                            if (item.NotifType == 3)
                            {
                            ...
                            if (item.NotifType == 5)
                            {
                                n.Link = "https://gianghuy.com/khieu-nai-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 8)
                            {
                                n.Link = "https://gianghuy.com/thanh-toan-ho-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 9)
                            {
                                n.Link = "https://gianghuy.com/lich-su-giao-dich-tien-te-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 10)
                            {
                                n.Link = "https://gianghuy.com/van-chuyen-ho-app.aspx?UID=" + UID + "&Key=" + Key + "";
                                n.Type = 2;
                            }
                            if (item.NotifType == 11)
                            {
                                n.Link = "https://gianghuy.com/chi-tiet-don-hang-khac-app.aspx?UID=" + UID + "&OrderID=" + item.OrderID + "&Key=" + Key + "";
                                n.Type = 1;
                            }
        ...
        {
            ResponseClass rs = new ResponseClass();
            List<WareHouseFrom> wareHouseFrom = new List<WareHouseFrom>();
            var warehouseTQ = WarehouseFromController.GetAllWithIsHidden(false);
            if (warehouseTQ.Count > 0)
            {
                foreach (var item in warehouseTQ)
                {
                    wareHouseFrom.Add(new WareHouseFrom() { ID = item.ID, WareHouseName = item.WareHouseName });
                }
            }
            List<WareHouseTo> wareHouseTo = new List<WareHouseTo>();
            var warehouses = WarehouseController.GetAllWithIsHidden(false);
            if (warehouses.Count > 0)
            {
                foreach (var item in warehouses)
                {
                    wareHouseTo.Add(new WareHouseTo() { ID = item.ID, WareHouseName = item.WareHouseName });
                }
            }
            List<ShippingType> shippingType = new List<ShippingType>();

            var shippingTypeToWarehouse = ShippingTypeToWareHouseController.GetAllWithIsHidden(false);
            if (shippingTypeToWarehouse.Count > 0)
            {
                foreach (var item in shippingTypeToWarehouse)
                {
                    shippingType.Add(new ShippingType() { ID = item.ID, ShippingName = item.ShippingTypeName });
                }
            }

            WareHouse wh = new WareHouse();
            wh.WareHouseFrom = wareHouseFrom;
            wh.WareHouseTo = wareHouseTo;
            wh.ShippingType = shippingType;
                ...
                if (tk != null)
                {
                    ...
                    if (obj_user != null)
                    {
                        ...
                        if (id.ToInt() > 0)
                        {
                            ...
                            //    try
                            //    {
                            //        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", "phuong@mona.media",
                            //            "Thông báo tại GIANGHUY.COM.", "Giá gốc của sản phẩm truyền lên bị rỗng.", "");
                            //    }
                            //    catch { }
                            //}
                            ...
                            //    {
                            //        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", "phuong@mona.media",
                            //            "Thông báo tại GIANGHUY.COM.", "Giá khuyến mãi của sản phẩm truyền lên bị rỗng.", "");
                            //    }
                            //    catch { }
                            //}
                            ...
                            //    {
                            //        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", "phuong@mona.media",
                            //            "Thông báo tại GIANGHUY.COM.", "Link của sản phẩm truyền lên bị rỗng.", "");
                            //    }
                            //    catch { }
                            //}
                            if (kq.ToInt(0) > 0)
                                            ...
                                            if (setNoti.IsSentEmailAdmin == true)
                                            {
                                                ...
                                                if (admins.Count > 0)
                                                {
                                                    foreach (var admin in admins)
                                                    {
                                                        ...
                                                        {
                                                            PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", admin.Email,
                                                                "Thông báo tại GIANGHUY.COM.", "Có đơn hàng mới ID là: " + idkq, "");
                                                        }
                                                        catch { }
                                                    }
                                                }
        ...
        public class ResponseClass
        {
            ...
            [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
            public List<Saler> ListSale { get; set; }
