        ...
        public void pagingall(List<tbl_ExportRequestTurn> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    html.Append("<p class=\"s-txt no-wrap\"><span class=\"total\">Tổng số kiện:</span><span> " + TotalPackages + " Kiện</span></p>");
                    html.Append("<p class=\"s-txt no-wrap\"><span class=\"total\">Tổng cân nặng:</span><span> " + item.TotalWeight + " Kg</span></p>");
                    html.Append("</td>");
                    ...
                    html.Append("<td style=\"font-weight:bold\">");
                    html.Append("<p class=\"s-txt blue-text no-wrap\"><span class=\"total\">Tổng bảo hiểm:</span><span> " + string.Format("{0:N0}", item.FeeInsurrane) + "</span></p>");
                    html.Append("<p class=\"s-txt red-text no-wrap\"><span class=\"total\">Tổng thanh toán:</span><span> " + string.Format("{0:N0}", item.TotalPriceVND) + "</span></p>");
                    html.Append("</td>");
