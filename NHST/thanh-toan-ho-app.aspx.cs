...
namespace NHST
{
    public partial class thanh_toan_ho_app : System.Web.UI.Page
    {
        ...
        protected void btnPayment_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                    ...
                    if (p != null)
                    {
                        ...
                        if (walletCYN > 0)
                        {
                            if (walletCYN >= TotalPrice)
                            {
                                ...
                                #endregion
                                int st = TransactionController.PayMent(UID, id, walletCYN_left, u.Username, TotalPrice, 1, 1, u.Username + " đã trả tiền thanh toán tiền hộ.", currentDate, 1);
                                if (st == 1)
                                {
                                    if (setNoti != null)
                                    {
                ...
                8, currentDate, u.Username, false);
                                                    ...
                                                    PJUtils.PushNotiDesktop(a.ID, u.Username + " đã trả tiền thanh toán hộ.", datalink);
                                                }
                                            }
                                        }
                                                ...
                                                foreach (var admin in admins)
                                                {
                                                    try
                                                    {
                                                        PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", admin.Email,
                                                            "Thông báo tại GIANGHUY.COM.", u.Username + " đã trả tiền thanh toán tiền hộ.", "");
                                                    }
                                                    catch { }
                            ...
                            else
                            {
                                ...
                                if (wallet >= totalpricevndpay)
                                {
                                    ...
                                    string content = u.Username + " đã trả tiền thanh toán tiền hộ.";
                                    int st = TransactionController.PaymentPayhelp(id, UID, u.Username, walletleft, 0, totalpricevndpay, content, 1, 9, 1, 1, walletCYN, 1, currentDate);
                                    if (st == 1)
                                    {
                                        if (setNoti != null)
                                        {
                    ...
                    8, currentDate, u.Username, false);
                        ...
                        else
                        {
                            if (wallet >= TotalPriceVND)
                            {
                                ...
                                #region Old
                                //AccountController.updateWallet(UID, walletleft, currentDate, username);
                                //HistoryPayWalletController.Insert(UID, username, 0, TotalPriceVND, username + " đã trả tiền thanh toán tiền hộ.", walletleft, 1, 9, currentDate, username);
                                //PayhelpController.UpdateStatus(id, 1, currentDate, username);
                                #endregion

                                int st = TransactionController.PayhelpWallet(id, 1, UID, u.Username, walletleft, TotalPriceVND, u.Username + " đã trả tiền thanh toán tiền hộ.", 1, 9, currentDate);
                                if (st == 1)
                                {
                                    if (setNoti != null)
                                    {
        ...
        //                                             {
        //                                                 PJUtils.SendMailGmail("gianghuycom@gmail.com.vn", "zioghzphiauqbdmw", admin.Email,
        //                                                     "Thông báo tại Giang Huy.", u.Username + " đã trả tiền thanh toán tiền hộ.", "");
        //                                             }
        //                                             catch { }
